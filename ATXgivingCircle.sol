...
USDCcontract public USDC; // implement USDC ERC20 interface with USDC contract address

address public circleleader; //needed to start first circle
...
uint public USDCperCircle; // initially 1000 USDC per circle

uint public weiMultiplier; // utilized in USDCperBean calc.
